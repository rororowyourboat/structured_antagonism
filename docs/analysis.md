...
*Topology diagram generated by gds-viz: [`docs/diagrams/gan.mermaid`](diagrams/gan.mermaid)*

Solid arrows = covariant (forward) flow. Double-line arrows = contravariant (feedback) flow.
...
*Topology diagram generated by gds-viz: [`docs/diagrams/euthyphro.mermaid`](diagrams/euthyphro.mermaid)*

Solid arrows = covariant flow. Dotted arrows = temporal (cross-timestep) wirings. The commitment store accumulates across turns — each turn adds a definition and a refutation. The loop terminates when the store trajectory enters a cycle.
...
*Topology diagram generated by gds-viz: [`docs/diagrams/co_scientist.mermaid`](diagrams/co_scientist.mermaid)*

Dotted arrows = temporal wirings. The inner loop (Evolution → Generation) iterates hypotheses within a round. The outer loop (Meta-Review → Generation) accumulates strategic insights across rounds.
